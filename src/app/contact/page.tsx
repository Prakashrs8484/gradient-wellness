        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              Contact <span className="text-gradient-to-r from-green-600 to-blue-600 bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent">Gradient Wellness</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-600 mb-8">
              ...
              <p><span className="font-semibold text-gray-900">Phone:</span> <a href="tel:+1234567890" className="text-green-600 hover:underline">(123) 456-7890</a></p>
              <p><span className="font-semibold text-gray-900">Email:</span> <a href="mailto:info@gradientwellness.com" className="text-green-600 hover:underline">info@gradientwellness.com</a></p>
            </div>
            <div className="mb-8">
              <iframe
          ...
          <div>
            ...
            <form className="space-y-6 bg-gray-50 rounded-xl p-8 shadow-lg">
              ...
              <div>
                ...
                <textarea id="message" name="message" rows={5} required className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"></textarea>
              </div>
              <button type="submit" className="w-full bg-gradient-to-r from-green-600 to-blue-600 text-white font-semibold py-3 rounded-lg hover:from-green-700 hover:to-blue-700 transition-all duration-300">
                Send Message
              </button>
            </form>
          </div>
